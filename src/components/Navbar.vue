  ...
  <nav class="navbar bg-white">
    <div class="container-fluid">
      <div class="d-flex gap-5">
        <MenuLateral v-if="store.state.login.key"/>
      ...
      <div class="d-flex gap-2">
        <div class="nav-item mx-3">
          <Modal
            class="nav-item"
            name="messages"
            btn="btn btn-outline-dark border-0 position-relative"
          >
        ...
        <div v-if="!store.state.login.user_id" class="nav-item mx-3">
          <button class="btn btn-outline-dark me-2" @click="navegar('/Login')">
            Login
          </button>
        </div>
        <div v-else class="nav-item dropdown mx-3">
          <a
          ...
          <ul class="dropdown-menu">
            ...
            <li>
              <button class="dropdown-item" type="button" @click="dashboard()">
                Dashboard
              </button>
            </li>
          </ul>
